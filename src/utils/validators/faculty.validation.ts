...
import { z } from 'zod';
import { Designation } from '@prisma/client'; // Import the enum from Prisma client

// Schema for creating a new faculty
export const createFacultySchema = z.object({
  name: z.string().min(1, 'Faculty name is required.'),
  abbreviation: z.string().min(1, 'Abbreviation is required.').optional(), // Optional, will default to name or generated
  ...
  designation: z
    ...
    .default(Designation.AsstProf), // Set default designation
...
export const batchCreateFacultiesSchema = z.object({
  faculties: z.array(createFacultySchema), // Array of createFacultySchema objects
});
